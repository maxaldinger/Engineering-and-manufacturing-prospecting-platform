      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {group.detectedSoftware.length === 0 && group.camRelevant && (
              <span className="text-[9px] uppercase tracking-wider px-1.5 py-0.5 rounded border border-primary/30 bg-primary-subtle text-primary">
                CAM-relevant
              </span>
            )}
            {group.detectedSoftware.length === 0 &&
              !group.camRelevant &&
              group.manufacturingRelevant && (
